...
//Le sous programme va prendre le tableau contenant les valeurs des cases, le numéro du joueur jouant et la position du joueur au tour précédent (valeur renvoyée après dans le main à la position du joueur,
// ex : posxy1[2], la première case du tableau correspondant à l'abscisse et la seconde à l'ordonnée)
    ...
    while (exit ==0) {
        ...
        switch (input) {
            case 1:
                ...
                {*posxy[0]=-1;} //si la position en haut n'a pas de mur en l'occurence
                else;
            case 2:
